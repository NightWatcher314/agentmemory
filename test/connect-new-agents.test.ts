...
// the canonical MCP block (npx @nightwatcher314/agentmemory-mcp + env defaults) into
...
describe("connect: Qwen Code", () => {
  ...
  it("writes mcpServers.agentmemory to ~/.qwen/settings.json", async () => {
    ...
    expect(cfg.mcpServers.agentmemory.args).toContain("@nightwatcher314/agentmemory-mcp");
...
describe("connect: Zed", () => {
  ...
  it("writes context_servers.agentmemory to ~/.config/zed/settings.json", async () => {
    ...
    expect(cfg.context_servers.agentmemory.args).toContain("@nightwatcher314/agentmemory-mcp");
...
describe("connect: Continue.dev", () => {
  ...
  it("creates config.yaml from scratch when neither yaml nor json exists", async () => {
    ...
    expect(yaml).toContain("@nightwatcher314/agentmemory-mcp");
  ...
  it("modifies existing legacy config.json", async () => {
    ...
    expect(entry.args).toContain("@nightwatcher314/agentmemory-mcp");
  });
