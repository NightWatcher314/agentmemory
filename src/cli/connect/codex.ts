...
export const adapter: ConnectAdapter = {
  ...
  docs: "https://github.com/NightWatcher314/agentmemory#codex-cli-codex-plugin-platform",
  protocolNote:
  ...
  async install(opts: ConnectOptions): Promise<ConnectResult> {
    ...
    p.log.info(
      "Codex picks up MCP servers on next launch. For the deeper plugin install, run: codex plugin marketplace add NightWatcher314/agentmemory && codex plugin add agentmemory@agentmemory",
    );
